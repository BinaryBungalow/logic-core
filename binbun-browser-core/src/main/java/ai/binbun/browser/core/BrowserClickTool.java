...
public final class BrowserClickTool implements Tool {
    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();
    private final BrowserToolBridge bridge;

    public BrowserClickTool(BrowserToolBridge bridge) {
        this.bridge = bridge;
    }
    ...
    public ToolSpec spec() {
        ...
        return new ToolSpec("browser.click", "Click a browser target selector", schema);
    }

    @Override
    public String execute(JsonNode arguments) {
        return bridge.invoke("browser.click", java.util.Map.of("target", arguments.path("target").asText(""))).detail();
    }
}
